package com.cellumed.healthcare.microfit.knee.Setting;
...
import com.cellumed.healthcare.microfit.knee.Home.Act_user_info;
...
public class Act_Setting extends BTConnectActivity implements OnAdapterClick {
    ...
    public void userInfoEdit (View view) {
        ...
        Intent intent = new Intent(this, Act_user_info.class);
    ...
    public  void systemInitDialog(){
        ...
        builder
                ...
                .onPositive((dialog, which) -> {
                    ...
                    new  com.cellumed.healthcare.microfit.knee.DataBase.DataBases(mContext).reset();
