...
@TargetApi(18)
public class Act_Rehab_Post extends BTConnectActivity implements IMP_CMD, SqlImp {
    ...
    private String rehab_send_txt="00";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_rehab_post);
    ...
    private void setPostData() {
        ...
        workoutData.put(PostEmgAvr3, String.valueOf(s_emg_amp_avr[2]));
        workoutData.put(PostEmgMax3, String.valueOf(s_emg_amp_max[2]));
        workoutData.put(PostEmgTotal3, String.valueOf(s_emg_totalWork[2]));
        workoutData.put(PostEmgAvr4, String.valueOf(s_emg_amp_avr[3]));
        workoutData.put(PostEmgMax4, String.valueOf(s_emg_amp_max[3]));
        workoutData.put(PostEmgTotal4, String.valueOf(s_emg_totalWork[3]));
        workoutData.put(PostEmgAvr5, String.valueOf(s_emg_amp_avr[4]));
        workoutData.put(PostEmgMax5, String.valueOf(s_emg_amp_max[4]));
        workoutData.put(PostEmgTotal5, String.valueOf(s_emg_totalWork[4]));

        if (new DBQuery(mContext).setProgramUpdate(workoutData,db_idx)) {
            Log.d("EMSPOST", "데이터 저장");
        }
    ...
    public void checkDonePopup () {
        ...
        builder
                .title(getString(R.string.PostRehab))
                .titleColor(Color.parseColor("#000000"))
                .backgroundColor(Color.parseColor("#aec7d5"))
                .content("사후평가가 완료되었습니다.")
    ...
    protected void dataAvailableCheck(String data) {
        ...
        else if (cmd.equals(CMD_REQ_REPORT_SENS))
        {
            if(report_cnt==0) {
                ...
                Log.d("TAG","SENS report ch recv post");
                String k;
                k= data.split(" ")[4];
