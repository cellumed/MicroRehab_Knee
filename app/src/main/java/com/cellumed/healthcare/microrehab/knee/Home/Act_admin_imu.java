...
*/
            ...
            Log.d("TAG","==== TEST12 ==== "+data.split(" ")[4]);
            Log.d("TAG","==== TEST13 ==== "+tmp);
            int idx = (int)((double)tmp/5.0);
            Log.d("TAG","==== TEST14 ==== "+idx);
            angle2=String.format("%02d",tmp);
            Log.d("TAG","==== TEST15 ==== "+angle2);
            if(idx < 1) idx=1;
            else if(idx > 35) idx=35;
            idx-=1;
            rtvB.setBackgroundResource(imageViewsB[idx]);
            String angle3 = Integer.toString(180-Integer.parseInt(angle2));

            ang_txt.setText(angle3);
